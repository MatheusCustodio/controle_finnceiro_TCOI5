...
class PlanoContasModel(models.Model):
    ...
    plano_contas_inicio_validade = models.DateField(null=True, blank=False, verbose_name="Inicio Validade")
    plano_contas_fim_validade = models.DateField(null=True, blank=False, verbose_name="Fim Validade")
